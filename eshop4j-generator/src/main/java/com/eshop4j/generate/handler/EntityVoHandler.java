package com.eshop4j.generate.handler;

import com.eshop4j.generate.config.ConfigFactory;
import com.eshop4j.generate.config.TableConfig;
import com.eshop4j.generate.model.Column;
import com.eshop4j.generate.model.EntityAttributeVo;
import com.eshop4j.generate.model.EntityVo;
import com.eshop4j.generate.model.SqlResultSet;
import com.eshop4j.generate.model.Table;
import com.eshop4j.generate.utils.StringUtils;
import com.eshop4j.generate.utils.JavaTypeResolverUtils.JdbcTypeInformation;
...
public class EntityVoHandler {
	...
	public static EntityVo createVo(Table table){
		...
		vo.setName(baseName);
		vo.setAliasName(StringUtils.lowerCaseFirstChar(baseName));
		vo.setMvcName(vo.getAliasName().toLowerCase());
