...
//		SecureRandom random = new SecureRandom();
		byte[] sharedSecret = StringUtils.getBytesUtf8("https://www.linkwee.com");
...
//		random.nextBytes(sharedSecret);
		...
		claimsSet.setIssuerClaim("https://www.linkwee.com");
		...
		assertEquals("https://www.linkwee.com", signedJWT.getJWTClaimsSet().getIssuerClaim());
