...
<div >
    ...
    <legend>基本信息</legend>
		<div class="prdAdd" style="margin-top: 40px">
			...
			<span class="rightsp"><input  class="easyui-validatebox" type="text" name="productName" data-options="required:true" id="productName" value="${dtl.productName }" ></span>
		</div>
		<div class="prdAdd">
    ...
    <select name="productCate" id="productCate" style="width:120px; ">
		...
		<div class="prdAdd">
			...
			<span class="rightsp">
			<input class="easyui-numberbox" type="text" name="buyTotalMoney" data-options="required:true" value="<fmt:formatNumber value="${dtl.buyTotalMoney }" pattern="0.00"/>" >
			<form:errors path="buyTotalMoney" cssClass="error" /> 
			</span>
		</div>
		<div class="prdAdd">
			<span class="leftsp">起投金额：</span>
			<span class="rightsp"><input class="easyui-numberbox" type="text" name="buyMinMoney"  missingMessage="" data-options="required:true" value="<fmt:formatNumber value="${dtl.buyMinMoney }" pattern="0.00"/>">
			<form:errors path="buyMinMoney" cssClass="error" /> 
			</span>
		</div>
		<div class="prdAdd">
			<span class="leftsp">递增金额：</span>
			<span class="rightsp"><input class="easyui-numberbox" type="text" name="buyIncreaseMoney"  data-options="required:true" value="<fmt:formatNumber value="${dtl.buyIncreaseMoney }" pattern="0.00"/>">
			<form:errors path="buyIncreaseMoney" cssClass="error" /> 
			</span>
		</div>
		<div class="prdAdd">
			<span class="leftsp">单用户购买上限：</span>
			<span class="rightsp"><input class="easyui-numberbox" type="text" name="custBuyMaxMoney" data-options="required:true" value="<fmt:formatNumber value="${dtl.custBuyMaxMoney }" pattern="0.00"/>">
			<form:errors path="custBuyMaxMoney" cssClass="error" /> 
			</span>
		</div>
		<div class="prdAdd">
			<span class="leftsp">投资期限：</span>
			<span class="rightsp"><input class="easyui-numberbox" type="text" name="deadLineValue" data-options="required:true" value="${dtl.deadLineValue }">天
			<form:errors path="custBuyMaxMoney" cssClass="error" /> 
			</span>
		</div>
		<div class="prdAdd">
			...
			<span class="rightsp">
			<%-- <input name="interestWay" type="radio" <c:if test="${dtl.interestWay eq 1}">checked="checked"</c:if> value="1" checked="checked">购买当日 <input name="interestWay" type="radio" <c:if test="${dtl.interestWay eq 2}">checked="checked"</c:if> value="2" > 购买次日 --%>
		...
		<div class="prdAdd">
			...
			<span class="rightsp">
				<input name="isCollect" type="radio"  value="1" <c:if test="${dtl.isCollect eq 1}">checked="checked"</c:if> >不进行募集 &nbsp;&nbsp;<input name="isCollect" type="radio"   value="2" <c:if test="${dtl.isCollect eq 2}">checked="checked"</c:if> > 进行限期募集
			</span>
		</div>
		<div class="prdAdd">
			<span class="leftsp">起息方式：</span>
			...
			<input name="interestWayType" type="radio"  value="1" <c:if test="${ empty dtl.validBeginDate }">checked="checked"</c:if>>
			</div>
		...
		<div id="raiseInfoDiv" style="display: <c:if test="${dtl.isCollect eq 1}">none</c:if><c:if test="${dtl.isCollect eq 2}">inline</c:if>;">
			...
			<span class="rightsp"><input class="easyui-validatebox"  name="collectEndTime"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width:150px"  value="<fmt:formatDate value="${dtl.collectEndTime }" pattern="yyyy-MM-dd" />">
			</span>
		</div>
		<div class="prdAdd">
			<span class="leftsp">投资客户募集期间收益：</span>
			<span class="rightsp"><input name="hasCollectRate" type="radio"  value="1" <c:if test="${! empty dtl.collectRate }">checked="checked"</c:if>>募集期间有收益<input type="text" style="width:80px;"  name="collectRate" id="collectRate" value="<fmt:formatNumber value="${dtl.collectRate }" pattern="0.00"/>" />%
			 &nbsp;&nbsp;<input name="hasCollectRate" type="radio"  value="0" <c:if test="${ empty dtl.collectRate }">checked="checked"</c:if>>募集期间无收益
			</span>
		</div>
		<div class="prdAdd">
			<span class="leftsp">理财师募集期间佣金：</span>
			<span class="rightsp"><input name="hasCollectRatio" type="radio"  value="1" <c:if test="${! empty dtl.collectRatio }">checked="checked"</c:if>>募集期间有佣金<input type="text" style="width:80px; " name="collectRatio" id="collectRatio" value="<fmt:formatNumber value="${dtl.collectRatio }" pattern="0.00"/>"  />%
			&nbsp;&nbsp;<input name="hasCollectRatio" type="radio"  value="0" <c:if test="${empty dtl.collectRatio }">checked="checked"</c:if>>募集期间无佣金
			</span>
		</div>
<!-- 		<div class="prdAdd">
    ...
    <legend>投资端信息</legend>
    	<div class="prdAdd">
			...
			<span class="rightsp"><input  class="easyui-validatebox"  value="<fmt:formatNumber value="${dtl.fixRate }" pattern="0.00"/>" type="text" name="fixRate" data-options="required:true,validType:'number'">%*支持两位小数</span>
		</div>
		<div class="prdAdd">
			<span class="leftsp">显示标签：</span>
			<span class="rightsp"><%-- <input class="easyui-validatebox"  type="text" name="invCornerIco" style="width:120px; " value="${dtl.invCornerIco }" placeholder="标签1（角标）"> --%>
			<input  class="easyui-validatebox"  type="text" name="invLabel1" style="width:120px; " value="${dtl.invLabel1 }" placeholder="标签1">
			<input  class="easyui-validatebox"  type="text" name="invLabel2" style="width:120px; " value="${dtl.invLabel2 }" placeholder="标签2"></span>
		</div>
		...
		<div class="prdAdd">
			...
			<input  class="easyui-validatebox"  type="text" name="productProtocalName" data-options="required:true"  id="productProtocalName" placeholder="协议名称" value="${dtl.productProtocalName }">
				<input  class="easyui-validatebox"  type="text" name="productProtocalId" data-options="required:true"  placeholder="协议链接" id="productProtocalId" value="${dtl.productProtocalId }">
		...
		<div class="prdAdd">
			...
			<input  class="easyui-validatebox"  type="text" name="ransferProtocalName"  id="ransferProtocalName" placeholder="协议名称" value="${dtl.ransferProtocalName }">
				<input  class="easyui-validatebox"  type="text" name="ransferProtocalUrl"  id="ransferProtocalUrl" placeholder="协议链接" value="${dtl.ransferProtocalUrl }">
    ...
    <legend>理财师端信息</legend>
    	<div class="prdAdd">
			...
			<span class="rightsp"><input  class="easyui-numberbox"  type="text" name="feeRatio" value="<fmt:formatNumber value="${dtl.feeRatio }" pattern="0.00"/>" data-options="min:0,precision:2,required:true,validType:'number'">%*支持两位小数</span>
		</div>
		<div class="prdAdd">
			<span class="leftsp">销售奖励：</span>
			<span class="rightsp"><input  class="easyui-numberbox"  type="text" name="saleReward" value="<fmt:formatNumber value="${dtl.saleReward }" pattern="0.00"/>" data-options="min:0,precision:2,validType:'number'">% *支持两位小数</span>
		</div>
		<div class="prdAdd">
			<span class="leftsp">显示标签：</span>
			<span class="rightsp"><%-- <input  class="easyui-validatebox"  type="text" name="lcsCornerIco" style="width:120px; " value="${dtl.lcsCornerIco }" placeholder="标签1（角标）"> --%>
			<input  class="easyui-validatebox"  type="text" name="lcsLabel1" style="width:120px; " value="${dtl.lcsLabel1 }" placeholder="标签1">
			<input  class="easyui-validatebox"  type="text" name="lcsLabel2" style="width:120px; " value="${dtl.lcsLabel2 }" placeholder="标签2"></span>
		</div>
