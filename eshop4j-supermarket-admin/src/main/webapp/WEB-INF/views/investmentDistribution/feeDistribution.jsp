...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-7 col-sm-offset-1">
			...
			<div class="row">
				<div class="col-sm-5">
						<h4>时间内，平均年化额最多的Top100：</h4>
				</div>
				<div class="col-sm-4">
						<a class="btn btn-default J_topListDownload" href="rest/investmentDistribution/topListDownload" role="button"><i class="fa fa-download"></i> 导出</a>
				</div>
			</div>
...
<script type="text/javascript" >
 $(document).ready(function() {
	 ...
	 var feeDistributionRatio_chart = echarts.init(document.getElementById('feeDistributionRatio_chart'));
        ...
        function searchTopList(data){
           $.post('rest/investmentDistribution/topList',data, function(data, textStatus, xhr) {
             $("#topDiv").html(data);
             });
        }
        function searchFeeDistributionDatailPage(data){
        	//data.type = $("#type").val();
            $.post('rest/investmentDistribution/feeDataDetailPage',data, function(data, textStatus, xhr) {
               $("#feeDistributionDatail_div").html(data);
              });
         }

         function  searchFeeDistributionRatio(data){
             $.post('rest/investmentDistribution/feeDistributionRatio',data, function(data, textStatus, xhr) {
        ...
        function searchFeeDistributionDatail(data){
           $.post('rest/investmentDistribution/feeDataDetail',data, function(data, textStatus, xhr) {
 ...
 function exportCfpAchievement(){
	   $form = $("#exportCfpAchievement").attr("action","rest/investmentDistribution/exportTopList");
		$form[0].submit();
		return false;
 }
