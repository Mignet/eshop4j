...
<input type="hidden" id="salesOrgId" value="${crmSalesOrg.salesOrgId}">
			<div class="page-header">
				<div class="row">
					<div class="col-md-8">
						<h4><small><p class="text-muted">批量归属理财师</p></small></h4>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<label class="col-sm-2 control-label">
					 <span style="color: ;font-size: 10px;">请点击下载<a href="/rest/crmSalesOrg/downloadExcelTemplate">《模板》</a>，仅支持xls文件，最大10000条.</span>
				</label>
			</div>
...
$(document).ready(function() {
	...
	//正式发送红包
 	$(".J_sendRedpacket").click(function() {
 		...
 		formData.append('salesOrgId',$("#salesOrgId").val());
 		$.ajax({
 	 		    url: './rest/crmSalesOrg/importCfp',
 	 		    type: 'POST',
 	 		    cache: false,
 	 		    data: formData,
 	 		    processData: false,
