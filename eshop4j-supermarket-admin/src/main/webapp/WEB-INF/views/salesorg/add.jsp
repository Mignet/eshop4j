...
<form id="redpacketFrom">
			...
			<div class="row">
				...
				<div class="col-md-4">
					 <input type="text" class="form-control" name="legalPerson" autocomplete="off"  />
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-md-4">
					 <input type="text" class="form-control" name="contacts" autocomplete="off"  />
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-md-4">
					 <input type="text" class="form-control" name="contactMobile" autocomplete="off" />
				</div>
			...
			<div class="row">
				...
				<div class="col-md-4">
					 <input type="text" class="form-control" name="managerAccount" autocomplete="off"  />
				</div>
			</div>
			<br>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-4">
				<input id="cooperationTime" name="cooperationTime" class="Wdate" type="text" value ="" onfocus="WdatePicker()" />
				</div>
			</div>
			<br>
			<div class="row">
...
$(document).ready(function() {
    ...
    $(".J_addRedpacket").on("click", function(event) {
    	...
    	if(!data.password){
            layer.msg('登录密码不能为空',{time: 1000,icon: 0});
           return false;
   		}
    	$.post('rest/crmSalesOrg/addOrg', data, function(data, textStatus, xhr) {
