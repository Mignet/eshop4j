...
<!-- BEGIN LOGIN -->
<div class="content">
	<p class="text-error"><font color="red"><b>${error }</b></font></p>
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="rest/auth/login" method="post">
		...
		<div class="form-actions">
			<span style="line-height: 34px; color: #EEEEEE;">请不要在公共场所登录系统</span>
			<label style="display: none;"><input type="checkbox" name="remember" value="1" style="display: none;" /> 记住我 </label>
	...
	<form class="forget-form" action="mailto:caiwei4@tophlc.com?subject=修改密码申请" method="post">
		<h3>忘记密码 ?</h3>
		<p>
			 请输入您的电子邮箱地址来重置您的密码.
		</p>
