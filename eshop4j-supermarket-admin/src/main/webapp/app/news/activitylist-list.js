...
$(document).ready(function() {
    editor = new $.fn.dataTable.Editor( {
    	ajax: {
            create: {
                type: 'POST',
                url:  'rest/cms/activitylist/save',
        ...
        /* {
         ...
         {
                label: "活动状态:0:进行中,1:结束:",
                name: "status"
            }, 
         {
                label: "活动类别:0:钱罐子活动,1理财师活动:",
                name: "activityType"
            }, 
         {
                label: "活动编码:",
    ...
    var table = $('#dtable').DataTable( {
        ...
        "ajax": {
            "url": "/rest/cms/activitylist/list",
            "type": "POST",
            "data":function(d){return {'_dt_json':JSON.stringify(d)};}//传递对象太多，json化
        },
        "columns": [
            { "data": "id","orderable": false },
            { "data": "activityName","orderable": false },
            { "data": "activityImg","orderable": false },
           /* { "data": "linkUrl","orderable": false },*/
            { "data": "startDate","orderable": false },
            { "data": "endDate","orderable": false },
            { "data": "status","orderable": false },
            { "data": "activityType","orderable": false },
            { "data": "activityCode","orderable": false },
            { "data": "appType","orderable": false },
            /*{ "data": "activityEndImg","orderable": false },
            { "data": "shareTitle","orderable": false },
            { "data": "shareDesc","orderable": false },
            { "data": "shareIcon","orderable": false },
            { "data": "shareLink","orderable": false },*/
