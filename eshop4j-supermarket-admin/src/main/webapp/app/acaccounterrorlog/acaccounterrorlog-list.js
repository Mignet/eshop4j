...
$(document).ready(function() {
    editor = new $.fn.dataTable.Editor( {
    	ajax: {
            create: {
                type: 'POST',
                url:  'rest/acc/acaccounterrorlog/save',
    ...
    var table = $('#dtable').DataTable( {
        ...
        "ajax": {
            "url": "/rest/acc/acaccounterrorlog/list",
            "type": "POST",
        ...
        "columns": [
            ...
            { "data": "classMethod","orderable": false },
            { "data": "sendParm","orderable": false },
            { "data": "returnParam","orderable": false },
