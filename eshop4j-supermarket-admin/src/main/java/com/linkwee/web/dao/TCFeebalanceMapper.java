...
public interface TCFeebalanceMapper extends GenericDao<TCFeebalance,Long>{
	...
	int updateFeebalanceStatus(@Param("beginTime")String begintime,@Param("endTime")String endTime,@Param("beforeStatus")List<Integer> beforeStatus,@Param("afterStatus")Integer afterStatus);
