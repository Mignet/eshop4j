...
public enum SmsTypeEnum implements KvmEnum{
	 ...
	 * 投资端  提现申请处理完成
	 */
	CTXAPPLYSUCCESS(4,"WITHDRAW",""),//投资端  提现申请处理完成
	/**
	 * 投资端  提现申请处理失败
	 */
	CTXAPPLYFAIL(5,"WITHDRAWFAIL",""),//投资端  提现申请处理失败
	 ...
	 * 理财师系统公告发布通知
	 */
	LCSSYSNOTICERELEASE(30,"LCSSYSNOTICERELEASE","lcsSysNoticeRelease"),//理财师系统公告发布通知
	/**
	 * 系统活动发布通知
	 */
	LCSSYSACTIVITYRELEASE(31,"LCSSYSACTIVITYRELEASE","lcsSysActivityRelease"),//理财师系统活动发布通知
	/**
	 * 投资端  提现记录
	 */
	WITHDRAWRECORD(32,"WITHDRAW","withdrawRecord"),//投资端  提现记录
	/**
	 * 收到系统，理财师红包，红包过期 （T呗）
	 */
	MYREDPACKET_INC(33,"MYREDPACKET","myRedpacket"),//投资端  我的红包
	/**
	 * 推荐用户注册完成（T呗）
	 */
	INVITATIONRECORD_INC(34,"INVITATIONRECORD_INC","invitationRecord"),//投资端  邀请记录
	/**
	 * 理财师推荐产品 （T呗）
	 */
	PRODUCTDTL_INC(35,"PRODUCTDTL_INC","productDtl"),//投资端  产品详情
	/**
	 * 理财师推荐平台（T呗）
	 */
	PLATFORMDTL_INC(36,"PLATFORMDTL_INC","platformDtl"),//投资端  平台详情
	/**
	 * 产品提前回款提醒和到期提醒 （T呗）
	 */
	MYINVESTRECORD_INC(37,"MYINVESTRECORD_INC","investRecord"),//投资端  我的投资
	/**
	 * 系统奖励发放、自动使用红包（T呗）
	 */
	REWARDBALANCE_INC(38,"REWARDBALANCE_INC","rewardBalance"),//投资端   T呗奖励余额
	/**
	 * 消息中心 （T呗）
	 */
	PERSONALMSGCT_INC(39,"PERSONALMSGCT_INC","notification");//投资端   个人消息中心
