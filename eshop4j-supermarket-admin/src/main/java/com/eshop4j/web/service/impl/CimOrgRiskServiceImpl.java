...
import com.eshop4j.web.dao.CimOrgRiskMapper;
import com.eshop4j.web.service.CimOrgRiskService;
import com.eshop4j.web.service.impl.CimOrgRiskServiceImpl;
...
public class CimOrgRiskServiceImpl extends GenericServiceImpl<CimOrgRisk, Long> implements CimOrgRiskService{
	...
	public CimOrgRisk queryOrgRiskInfo(int rid) {
		return cimOrgRiskMapper.queryOrgRiskInfo(rid);
	}

	@Override
	public void insertBatchRisk(List<CimOrgRisk> orgRisks) {
		cimOrgRiskMapper.insertBatchRisk(orgRisks);		
	}
