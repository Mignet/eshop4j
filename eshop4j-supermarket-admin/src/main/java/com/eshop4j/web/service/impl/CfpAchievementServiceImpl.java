...
import com.eshop4j.web.dao.CfpAchievementDao;
import com.eshop4j.web.dao.TorginfoDao;
import com.eshop4j.web.model.crm.CfpAchiAnalysisResp;
...
import com.eshop4j.web.service.CfpAchievementService;
...
public class CfpAchievementServiceImpl implements CfpAchievementService {
	...
	public investmentRateResp queryInvestmentRate(Map<String, String> query) {
		...
		return cfpAchievementDao.queryInvestmentRate(query);
	}
