...
public class CfpAchievementResp extends BaseEntity {
	...
	public String getCfpMobile() {
		if(cfpMobile != null && cfpMobile.length() >= 11) {
			return cfpMobile.substring(0,cfpMobile.length() - 8) + "****" + cfpMobile.substring(cfpMobile.length() - 4, cfpMobile.length());
		} else {
			return cfpMobile;
		}
	}
	...
	public String getInvestorMobile() {
		if(cfpMobile != null && cfpMobile.length() >= 11) {
			return investorMobile.substring(0,investorMobile.length() - 8) + "****" + investorMobile.substring(investorMobile.length() - 4, investorMobile.length());
		} else {
