...
public class BatchPayServiceLocator extends org.apache.axis.client.Service implements BatchPayService {
...
//    private java.lang.String BatchPayWS_address = "https://sandbox.99bill.com/apipay/services/BatchPayWS";
  private java.lang.String BatchPayWS_address = "https://www.99bill.com/apipay/services/BatchPayWS";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (BatchPay.class.isAssignableFrom(serviceEndpointInterface)) {
                BatchPayWSSoapBindingStub _stub = new BatchPayWSSoapBindingStub(new java.net.URL(BatchPayWS_address), this);
                _stub.setPortName(getBatchPayWSWSDDServiceName());
                return _stub;
            }
        }
