...
import com.eshop4j.web.service.impl.AcBankCardInfoServiceImpl;

@Component
public class AdvanceSendRedPacketExpireMsgJob extends AbstractSimpleElasticJob{
...
private static final Logger LOGGER = LoggerFactory.getLogger(AcBankCardInfoServiceImpl.class);
	...
	public void process(JobExecutionMultipleShardingContext shardingContext) {
		try {
			redpacketSendRecordService.advanceSendExpireMsg();
		} catch (Exception e) {
