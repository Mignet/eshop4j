package com.eshop4j.plugin.jedis;
...
//        shardedJedis = shardedJedisPool.getResource();
    ...
    private void initialShardedPool()
    {
        ...
        shards.add(new JedisShardInfo("192.168.1.160", 6379, "master"));
    ...
    private void testList()
    {
        ...
        System.out.println(shardedJedis.sort("lists",sp.alpha()));//如果没有加ALPHA参数的话，SORT命令会尝试将所有元素转换成双精度浮点数来比较，如果无法转换则会提示错误。
        // 字串
    ...
    private void testHash()
    {
     ...
     // 清空数据
      ...
      //模拟常规数据库操作
        //添加数据
        shardedJedis.hset("rules", "somaster", "name:销售单号,prefix:SO,time:YYYYMMDD,seq:seq_so,seq_len:6");
        shardedJedis.hset("rules", "pomaster", "name:采购单号,prefix:PO,time:YYYYMMDD,seq:seq_po,seq_len:6");
        ...
        System.out.println(shardedJedis.hset("rules", "somaster", "new somaster"));
        System.out.println("update after:"+shardedJedis.hvals("rules"));
        System.out.println("============= another hash test==========================");
