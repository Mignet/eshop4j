package com.eshop4j.api.wx.kit;
...
import com.eshop4j.api.wx.cache.LocalAccessTokenCache;
...
public class ApiConfigKit {
	private static final Logger LOGGER = LoggerFactory.getLogger(ApiConfigKit.class);
    ...
    static IAccessTokenCache accessTokenCache = new LocalAccessTokenCache();
