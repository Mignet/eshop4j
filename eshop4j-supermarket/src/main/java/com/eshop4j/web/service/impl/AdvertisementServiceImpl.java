...
public class AdvertisementServiceImpl implements AdvertisementService{
	...
	public ReturnCode DeleteAdv(Integer fid) {
		 ...
		 try {
			 smAdvertisementMapper.deleteByPrimaryKey(Long.valueOf(fid));
				...
				logger.error("advertisementDao.deleteByPrimaryKey invoke error:",e);
	...
	public ReturnCode SaveAdv(SmAdvertisement adv) {
		 try {
			...
			logger.error("advertisementDao.add invoke error:",e);
			return Error.DB_ERROR;
		}
	}
	...
	public ReturnCode updateAdv(SmAdvertisement adv) {
		 ...
		 try {
			 smAdvertisementMapper.updateByPrimaryKeySelective(adv);
				...
				logger.error("advertisementDao.update invoke error:",e);
				return Error.DB_ERROR;
			}
	}
	...
	public List<SmAdvertisement> findAdvertisementDtl(SmAdvertisement adv) {
		return smAdvertisementMapper.queryAdvertisement(adv);
	}
}