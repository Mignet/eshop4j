...
import com.eshop4j.web.model.CfpCancelValideModel;
...
import com.eshop4j.web.response.LcsCustomeDetailResp;
import com.eshop4j.web.response.LcsTeamDetailResp;
...
public interface CfplannerManagerDao  {
	 ...
	 * @return
	 */
	public PageList<CfpManagerDetailResp> queryLcsList(PageRequest pageRequest,RowBounds page);
