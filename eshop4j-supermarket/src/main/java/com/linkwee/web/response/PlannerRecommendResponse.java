 ...
 */
public class PlannerRecommendResponse extends BaseEntity {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 7935626884319040944L;


	public PlannerRecommendResponse() {
		
	}
	
	public PlannerRecommendResponse(CimOrginfo cimOrginfo) {
		...
		this.orgLogo = cimOrginfo.getPlatformIco();
