 ...
 */
public class CimPcNoLoginOrgListResponse extends BaseEntity {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = -2921851624700635932L;

	public CimPcNoLoginOrgListResponse() {}
	
	public CimPcNoLoginOrgListResponse(CimOrginfo cimOrginfo) {
