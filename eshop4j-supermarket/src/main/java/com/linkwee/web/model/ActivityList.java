...
public class ActivityList implements Serializable {
    ...
    /**
     *奖励发放方式（1：动态（活动期间），2：静态（活动结束））
     */
	private Integer prizeIssueStyle;
	
	/**
	 * 奖励结算时间（奖励发放方式为静态时有效）
	 */
	private Date prizeBalanceTime;
	...
	public Integer getPrizeIssueStyle() {
		return prizeIssueStyle;
	}

	public void setPrizeIssueStyle(Integer prizeIssueStyle) {
		this.prizeIssueStyle = prizeIssueStyle;
	}

	public Date getPrizeBalanceTime() {
		return prizeBalanceTime;
	}

	public void setPrizeBalanceTime(Date prizeBalanceTime) {
		this.prizeBalanceTime = prizeBalanceTime;
	}
