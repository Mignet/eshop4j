...
public class SmAppVersionServiceImpl extends GenericServiceImpl<SmAppVersion, Long> implements SmAppVersionService{
	...
	@Override
	public List<SmAppVersion> queryAppLogList(Integer appType,
			PlatformEnum platForm) {
		SmAppVersion smAppVersion = new SmAppVersion();
		smAppVersion.setAppType(appType);
		smAppVersion.setPlatform(platForm.getValue());
		smAppVersion.setStatus(0);
		List<SmAppVersion> appVersionList = smAppVersionMapper.queryAppLogList(smAppVersion);
